...
class $MembersTable extends Members with TableInfo<$MembersTable, MemberRow> {
  ...
  static const VerificationMeta _priesthoodOfficeMeta = const VerificationMeta(
    'priesthoodOffice',
  );
  @override
  late final GeneratedColumn<String> priesthoodOffice = GeneratedColumn<String>(
    'priesthood_office',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('priesthood_office')) {
      context.handle(
        _priesthoodOfficeMeta,
        priesthoodOffice.isAcceptableOrUnknown(
          data['priesthood_office']!,
          _priesthoodOfficeMeta,
        ),
      );
    }
  ...
  MemberRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MemberRow(
      ...
      priesthoodOffice: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}priesthood_office'],
      ),
...
class MemberRow extends DataClass implements Insertable<MemberRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || preferredName != null) {
    ...
    if (!nullToAbsent || priesthoodOffice != null) {
      map['priesthood_office'] = Variable<String>(priesthoodOffice);
    }
  ...
  MembersCompanion toCompanion(bool nullToAbsent) {
    return MembersCompanion(
      ...
      preferredName: preferredName == null && nullToAbsent
          ? const Value.absent()
          : Value(preferredName),
      ...
      priesthoodOffice: priesthoodOffice == null && nullToAbsent
          ? const Value.absent()
  ...
  factory MemberRow.fromJson(
    ...
    return MemberRow(
      ...
      priesthoodOffice: serializer.fromJson<String?>(json['priesthoodOffice']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'priesthoodOffice': serializer.toJson<String?>(priesthoodOffice),
  ...
  MemberRow copyWith({
    ...
    Value<String?> priesthoodOffice = const Value.absent(),
    bool? isActive,
    DateTime? createdAt,
    DateTime? updatedAt,
  }) => MemberRow(
    ...
    preferredName: preferredName.present
        ? preferredName.value
        : this.preferredName,
    ...
    priesthoodOffice: priesthoodOffice.present
        ? priesthoodOffice.value
        : this.priesthoodOffice,
  ...
  MemberRow copyWithCompanion(MembersCompanion data) {
    return MemberRow(
      ...
      priesthoodOffice: data.priesthoodOffice.present
          ? data.priesthoodOffice.value
          : this.priesthoodOffice,
  ...
  String toString() {
    return (StringBuffer('MemberRow(')
          ...
          ..write('sex: $sex, ')
          ..write('priesthoodOffice: $priesthoodOffice, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is MemberRow &&
          ...
          other.sex == this.sex &&
          other.priesthoodOffice == this.priesthoodOffice &&
...
class MembersCompanion extends UpdateCompanion<MemberRow> {
  ...
  final Value<String?> priesthoodOffice;
  ...
  const MembersCompanion({
    ...
    this.priesthoodOffice = const Value.absent(),
  ...
  static Insertable<MemberRow> custom({
    ...
    Expression<String>? priesthoodOffice,
    ...
    return RawValuesInsertable({
      ...
      if (sex != null) 'sex': sex,
      if (priesthoodOffice != null) 'priesthood_office': priesthoodOffice,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (priesthoodOffice.present) {
      map['priesthood_office'] = Variable<String>(priesthoodOffice.value);
    }
    if (isActive.present) {
...
class $CallingEventsTable extends CallingEvents
  ...
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $CallingEventsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  $CallingEventsTable createAlias(String alias) {
    return $CallingEventsTable(attachedDatabase, alias);
  }
}
...
class CallingEventRow extends DataClass implements Insertable<CallingEventRow> {
  ...
  CallingEventsCompanion toCompanion(bool nullToAbsent) {
    return CallingEventsCompanion(
      id: Value(id),
...
class CallingEventsCompanion extends UpdateCompanion<CallingEventRow> {
  ...
  CallingEventsCompanion copyWith({
    Value<String>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('CallingEventsCompanion(')
          ..write('id: $id, ')
          ..write('callingId: $callingId, ')
          ..write('state: $state, ')
          ..write('occurredAt: $occurredAt, ')
...
class $TrackedActivitiesTable extends TrackedActivities
    with TableInfo<$TrackedActivitiesTable, TrackedActivityRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TrackedActivitiesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'tracked_activities';
  @override
  VerificationContext validateIntegrity(
    Insertable<TrackedActivityRow> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TrackedActivityRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $TrackedActivitiesTable createAlias(String alias) {
    return $TrackedActivitiesTable(attachedDatabase, alias);
  }
}

class TrackedActivityRow extends DataClass
  ...
  TrackedActivitiesCompanion toCompanion(bool nullToAbsent) {
  ...
  factory TrackedActivityRow.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  TrackedActivityRow copyWithCompanion(TrackedActivitiesCompanion data) {
    return TrackedActivityRow(
      id: data.id.present ? data.id.value : this.id,
      memberId: data.memberId.present ? data.memberId.value : this.memberId,
      title: data.title.present ? data.title.value : this.title,
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $CallingEventsTable callingEvents = $CallingEventsTable(this);
...
class $$MembersTableFilterComposer
  ...
  ColumnFilters<String> get priesthoodOffice => $composableBuilder(
    column: $table.priesthoodOffice,
    builder: (column) => ColumnFilters(column),
  );
...
class $$MembersTableOrderingComposer
  ...
  ColumnOrderings<String> get priesthoodOffice => $composableBuilder(
    column: $table.priesthoodOffice,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$MembersTableAnnotationComposer
  ...
  GeneratedColumn<String> get priesthoodOffice => $composableBuilder(
    column: $table.priesthoodOffice,
    builder: (column) => column,
  );
...
typedef $$CallingsTableUpdateCompanionBuilder =
    CallingsCompanion Function({
      Value<String> id,
      Value<String> memberId,
      Value<String> title,
...
typedef $$CallingEventsTableCreateCompanionBuilder =
    CallingEventsCompanion Function({
      required String id,
      required String callingId,
      required String state,
      required DateTime occurredAt,
...
typedef $$CallingEventsTableUpdateCompanionBuilder =
    CallingEventsCompanion Function({
      Value<String> id,
      Value<String> callingId,
      Value<String> state,
...
class $$CallingEventsTableFilterComposer
    extends Composer<_$AppDatabase, $CallingEventsTable> {
...
class $$CallingEventsTableOrderingComposer
    extends Composer<_$AppDatabase, $CallingEventsTable> {
...
class $$CallingEventsTableAnnotationComposer
    extends Composer<_$AppDatabase, $CallingEventsTable> {
...
class $$CallingEventsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $CallingEventsTable,
  ...
  $$CallingEventsTableTableManager(_$AppDatabase db, $CallingEventsTable table)
    : super(
        TableManagerState(
          ...
          table: table,
          createFilteringComposer: () =>
              $$CallingEventsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$CallingEventsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$CallingEventsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
...
typedef $$CallingEventsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CallingEventsTable,
      CallingEventRow,
      ...
      PrefetchHooks Function()
    >;
typedef $$TrackedActivitiesTableCreateCompanionBuilder =
...
typedef $$TrackedActivitiesTableUpdateCompanionBuilder =
    TrackedActivitiesCompanion Function({
      Value<String> id,
      Value<String?> memberId,
      Value<String> title,
...
class $$TrackedActivitiesTableFilterComposer
    extends Composer<_$AppDatabase, $TrackedActivitiesTable> {
  $$TrackedActivitiesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TrackedActivitiesTableOrderingComposer
    extends Composer<_$AppDatabase, $TrackedActivitiesTable> {
  $$TrackedActivitiesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TrackedActivitiesTableAnnotationComposer
    extends Composer<_$AppDatabase, $TrackedActivitiesTable> {
  $$TrackedActivitiesTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TrackedActivitiesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $TrackedActivitiesTable,
          TrackedActivityRow,
          $$TrackedActivitiesTableFilterComposer,
          $$TrackedActivitiesTableOrderingComposer,
          $$TrackedActivitiesTableAnnotationComposer,
          $$TrackedActivitiesTableCreateCompanionBuilder,
          $$TrackedActivitiesTableUpdateCompanionBuilder,
          (
            TrackedActivityRow,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$TrackedActivitiesTableTableManager(
    _$AppDatabase db,
    $TrackedActivitiesTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$TrackedActivitiesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$TrackedActivitiesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$TrackedActivitiesTableAnnotationComposer(
                $db: db,
                $table: table,
...
typedef $$TrackedActivitiesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $TrackedActivitiesTable,
      TrackedActivityRow,
...
class $AppDatabaseManager {
  ...
  $$CallingEventsTableTableManager get callingEvents =>
      $$CallingEventsTableTableManager(_db, _db.callingEvents);
  $$TrackedActivitiesTableTableManager get trackedActivities =>
